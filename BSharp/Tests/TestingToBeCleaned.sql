...
BEGIN 
  ...
  [StartDateTime], [EndDateTime], [LinesCustodyId1], [LinesCustodyId2], [LinesCustodyId3], [LinesReference1],	[LinesReference2], [LinesReference3])
...
-- Line 1: Camry
	...
	INSERT INTO @WideLines(DocumentId, LineNumber, DocumentType, ResponsibleAgentId, StartDateTime, EndDateTime, Operation1, CustodyId1, ResourceId1, Amount1, Amount2, RelatedAmount2, Amount3)
...
-- Camry
	...
	INSERT INTO @WideLines(DocumentId, LineNumber, LineType, ResponsibleAgentId, StartDateTime, EndDateTime, Operation1, CustodyId1, ResourceId1, Amount1, CustodyId2)
...
-- Purchase invoice
	...
	INSERT INTO @WideLines(DocumentId, LineNumber, [DocumentType], ResponsibleAgentId, StartDateTime, EndDateTime, 
			Operation1, CustodyId1, ResourceId1, Amount1,	Value1,				Amount2, Reference2, RelatedReference2)
...
-- Line 1: MA, Basic
	...
	INSERT INTO @WideLines(DocumentId, LineNumber, [DocumentType], ResponsibleAgentId, StartDateTime, EndDateTime, Operation1, CustodyId1, Amount2, Amount3)
...
-- Line 3: AA, Basic
	...
	INSERT INTO @WideLines(DocumentId, LineNumber, [DocumentType], ResponsibleAgentId, StartDateTime, EndDateTime, Memo, Operation1, CustodyId1, Amount2, Amount3)
...
-- MA
	...
	INSERT INTO @WideLines(DocumentId, LineNumber, [DocumentType], ResponsibleAgentId, StartDateTime, EndDateTime, Memo, Operation1, CustodyId1, Amount1, CustodyId2)
