CREATE TABLE [dbo].[DocumentActions] (
	...
	CONSTRAINT [CK_DocumentActions_Action] CHECK ([Action] IN (N'New', N'DraftToVoid', N'DraftToPosted',
				N'PostedToDraft', N'Signed', N'Unsigned', N'Delegated', N'Merged', N'Splitted', N'Decomposed'))
);