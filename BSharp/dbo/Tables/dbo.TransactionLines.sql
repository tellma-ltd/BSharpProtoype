...
-- for auditing
	...
	CONSTRAINT [CK_TransactionLines__Direction]	CHECK ([Direction] IN (-1, 1)),
	...
	CONSTRAINT [FK_TransactionLines__Accounts]	FOREIGN KEY ([TenantId], [AccountId])	REFERENCES [dbo].[Accounts] ([TenantId], [Id]),
	CONSTRAINT [FK_TransactionLines__IfrsNotes]	FOREIGN KEY ([TenantId], [IfrsNoteId])	REFERENCES [dbo].[IfrsNotes] ([TenantId], [Id]),
	CONSTRAINT [FK_TransactionLines__ResponsibilityCenters]	FOREIGN KEY ([TenantId], [ResponsibilityCenterId]) REFERENCES [dbo].[ResponsibilityCenters] ([TenantId], [Id]),
	CONSTRAINT [FK_TransactionLines__AgentAccounts]	FOREIGN KEY ([TenantId], [AgentAccountId])	REFERENCES [dbo].[AgentRelations] ([TenantId], [Id]),
	CONSTRAINT [FK_TransactionLines__Resources]	FOREIGN KEY ([TenantId], [ResourceId])	REFERENCES [dbo].[Resources] ([TenantId], [Id]),
	...
	CONSTRAINT [FK_TransactionLines__SignedById]FOREIGN KEY ([TenantId], [SignedById])REFERENCES [dbo].[LocalUsers] ([TenantId], [Id])
);
GO
CREATE INDEX [IX_TransactionLines__DocumentId] ON [dbo].[TransactionLines]([TenantId] ASC, [DocumentId] ASC);
GO
CREATE INDEX [IX_TransactionLines__ResponsibilityCenterId] ON [dbo].[TransactionLines]([TenantId] ASC, [ResponsibilityCenterId] ASC);
GO
CREATE INDEX [IX_TransactionLines__AccountId] ON [dbo].[TransactionLines]([TenantId] ASC, [AccountId] ASC);
GO
CREATE INDEX [IX_TransactionLines__IfrsNoteId] ON [dbo].[TransactionLines]([TenantId] ASC, [IfrsNoteId] ASC);
GO