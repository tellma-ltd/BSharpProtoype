CREATE TABLE [dbo].[AccountsNotes] (
	...
	CONSTRAINT [FK_AccountsNotes_Accounts] FOREIGN KEY ([TenantId], [AccountId]) REFERENCES [dbo].[Accounts] ([TenantId], [Id]), 
	CONSTRAINT [FK_AccountsNotes_Notes] FOREIGN KEY ([TenantId], [NoteId]) REFERENCES [dbo].[Notes] ([TenantId], [Id])
);
GO;
