...
-- for auditing
	...
	CONSTRAINT [PK_DocumentLineEntries] PRIMARY KEY CLUSTERED ([TenantId] ASC, [Id] ASC),
	CONSTRAINT [CK_DocumentLineEntries__Direction]	CHECK ([Direction] IN (-1, 1)),
	CONSTRAINT [FK_DocumentLineEntries__DocumentLineId]	FOREIGN KEY ([TenantId], [DocumentLineId])	REFERENCES [dbo].[DocumentLines] ([TenantId], [Id]) ON DELETE CASCADE,
	CONSTRAINT [FK_DocumentLineEntries__Accounts]	FOREIGN KEY ([TenantId], [AccountId])	REFERENCES [dbo].[Accounts] ([TenantId], [Id]),
	CONSTRAINT [FK_DocumentLineEntries__IfrsNotes]	FOREIGN KEY ([TenantId], [IfrsNoteId])	REFERENCES [dbo].[IfrsNotes] ([TenantId], [Id]),
	CONSTRAINT [FK_DocumentLineEntries__ResponsibilityCenters]	FOREIGN KEY ([TenantId], [ResponsibilityCenterId]) REFERENCES [dbo].[ResponsibilityCenters] ([TenantId], [Id]),
	CONSTRAINT [FK_DocumentLineEntries__Resources]	FOREIGN KEY ([TenantId], [ResourceId])	REFERENCES [dbo].[Resources] ([TenantId], [Id]),
	CONSTRAINT [FK_DocumentLineEntries__ResourceInstances] FOREIGN KEY ([TenantId], [InstanceId]) REFERENCES [dbo].[ResourceInstances] ([TenantId], [Id]),
	CONSTRAINT [FK_DocumentLineEntries__CreatedById]	FOREIGN KEY ([TenantId], [CreatedById])	REFERENCES [dbo].[LocalUsers] ([TenantId], [Id]),
	CONSTRAINT [FK_DocumentLineEntries__ModifiedById]FOREIGN KEY ([TenantId], [ModifiedById])REFERENCES [dbo].[LocalUsers] ([TenantId], [Id]),
);
GO
CREATE INDEX [IX_DocumentLineEntries__DocumentId] ON [dbo].[DocumentLineEntries]([TenantId] ASC, [DocumentLineId] ASC);
GO
CREATE INDEX [IX_DocumentLineEntries__ResponsibilityCenterId] ON [dbo].[DocumentLineEntries]([TenantId] ASC, [ResponsibilityCenterId] ASC);
GO
CREATE INDEX [IX_DocumentLineEntries__AccountId] ON [dbo].[DocumentLineEntries]([TenantId] ASC, [AccountId] ASC);
GO
CREATE INDEX [IX_DocumentLineEntries__IfrsNoteId] ON [dbo].[DocumentLineEntries]([TenantId] ASC, [IfrsNoteId] ASC);
GO