...
--	Its scope is 
	...
	CONSTRAINT [FK_Documents__DocumentTypeId] FOREIGN KEY ([TenantId], [DocumentTypeId]) REFERENCES [dbo].[DocumentTypes] ([TenantId], [Id]) ON UPDATE CASCADE, 
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_Documents__VoucherBooklet_VoucherNumericReference]
  ON [dbo].[Documents]([TenantId], [VoucherBookletId], [VoucherNumericReference])
