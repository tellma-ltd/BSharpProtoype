CREATE FUNCTION [dbo].[fi_ERCA__VAT_SalesDetails] (
...
RETURN
	...
	AND J.[Direction] = -1
	GROUP BY A.[Name], A.[TaxIdentificationNumber], J.[Reference], 
			J.[RelatedResourceId], J.[RelatedReference], J.[DocumentDate];