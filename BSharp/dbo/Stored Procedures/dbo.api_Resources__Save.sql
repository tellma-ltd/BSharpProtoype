...
BEGIN
	...
	(
		...
		USING (
			SELECT @TenantId As [TenantId], [Id], [ResourceType], [Name], [Code], [UnitOfMeasure], [Memo], [Lookup1], [Lookup2], [Lookup3], [Lookup4], [PartOf], [FungibleParentId]
			FROM @Resources 
		...
		WHEN NOT MATCHED THEN
			INSERT ([TenantId], [ResourceType],		[Name],	[Code], [UnitOfMeasure],	 [Memo],	[Lookup1],	[Lookup2],	[Lookup3],		[Lookup4], [PartOf], [FungibleParentId])
			VALUES (@TenantId, s.[ResourceType], s.[Name], s.[Code], s.[UnitOfMeasure], s.[Memo], s.[Lookup1], s.[Lookup2], s.[Lookup3], s.[Lookup4], s.[PartOf], s.[FungibleParentId])
	...
	*/
	...
	SELECT R.[Id], R.[ResourceType], R.[Name], R.[Code], R.[UnitOfMeasure], R.[Memo], R.[Lookup1], R.[Lookup2], R.[Lookup3], R.[Lookup4], R.[PartOf], R.[FungibleParentId], N'Unchanged' As [Status], M.[OldId] As [TemporaryId]
