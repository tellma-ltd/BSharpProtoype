...
-- Deletions
	...
	(
		...
		WHEN NOT MATCHED THEN
			INSERT ([TenantId], [MassUnitId], [ResourceType],	[Name],	[Name2], [Code],		[SystemCode],	 [Memo],	[Lookup1Id],	[Lookup2],	[Lookup3],	[Lookup4],	[PartOfId],		[InstanceOfId], [CreatedAt], [CreatedById], [ModifiedAt], [ModifiedById])
