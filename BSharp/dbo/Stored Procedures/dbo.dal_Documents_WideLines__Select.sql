...
SET NOCOUNT ON;
	...
	SELECT @DocumentsResultJson =	(
		SELECT T.[Index], D.[Id], D.[State], D.[DocumentType], D.[Mode], D.[SerialNumber], 
		D.[Frequency], D.[Duration], D.[StartDateTime], D.[EndDateTime],
		--D.[Memo], D.[LinesCustody1], D.[LinesCustody2], D.[LinesCustody3],
