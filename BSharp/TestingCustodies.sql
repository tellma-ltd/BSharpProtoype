...
BEGIN -- Locations
	BEGIN -- Insert 
		...
		([Id], [LocationType], [Name],						[Address], [Parent],[Custodian]) VALUES
		...
		DELETE FROM @LocationsResult; INSERT INTO @LocationsResult([Id], [LocationType], [Name], [IsActive], [Address], [Parent],[Custodian], [Status], [TemporaryId])
